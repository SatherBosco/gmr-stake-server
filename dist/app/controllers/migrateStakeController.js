...
const BUSD_json_1 = __importDefault(require("../contracts/BUSD.json"));
...
class MigrateStakeController {
    ...
    bnb(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (stake.bnb)
                    return res.status(400).send({ message: "Já recebeu BNB." });
    ...
    withdrawReward(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (reward.withdraw)
                    return res.status(400).send({ message: "Rendimentos já sacado." });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (let index = 0; index < addressReward.length; index++) {
                    ...
                    yield RewardModel_1.default.create(data);
                }
    ...
    rewardDistr(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (let index = 0; index < address.length; index++) {
                    var stake = yield RewardModel_1.default.findOne({ wallet: address[index].toLowerCase() });
                    if (stake) {
                        if (stake.withdraw) {
